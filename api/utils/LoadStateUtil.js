...
exports.getStatesFromExcel = function () {
    try {
...
/*          var s3 = new AWS.S3(),
      ...
      let stream=fs.createReadStream("C:/Users/utadmin/Documents/States_te.xlsx");
        ...
        reader.eachRow((rowData, rowNum, sheetSchema) => {
           /* var product_sku=productSku.getSku();
            ...
            .then(() => {
                ...
                console.log(error);
                reject("unable get states from Excel"+error);
            })
        })// end of promise
    }// end of try
    catch (error) {
